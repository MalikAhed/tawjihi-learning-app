    ...
    Object.freeze({
      ...
      lessons:Object.freeze([
        ...
        Object.freeze({
          ...
          parts:Object.freeze([
            Object.freeze({ id:"access-basics", label:"برامج إدارة البيانات وبيئة Access", pages:"3–4", startStepId:"database-management-mission" }),
            ...
            Object.freeze({ id:"practice-and-review", label:"تطبيق المستشفى ومراجعة الوحدة", pages:"11، 34", startStepId:"hospital-transfer" }),
          ]),
          xp:10,
        }),
        Object.freeze({
          ...
          parts:Object.freeze([
            ...
            Object.freeze({ id:"select-order", label:"اختيار البيانات وترتيبها", pages:"16–19", startStepId:"sql-select-order-mission" }),
            Object.freeze({ id:"where-conditions", label:"الشروط والمعاملات", pages:"19–22", startStepId:"sql-where-conditions-mission" }),
            Object.freeze({ id:"related-tables", label:"الاستعلام من جداول مترابطة", pages:"23–25", startStepId:"sql-related-tables-mission" }),
            Object.freeze({ id:"count-parameters", label:"عدّ السجلات والاستعلام بالمعاملات", pages:"24–25", startStepId:"sql-count-parameters-mission" }),
            Object.freeze({ id:"update-queries", label:"استعلامات التحديث", pages:"25–27", startStepId:"sql-update-queries-mission" }),
            Object.freeze({ id:"insert-queries", label:"الإدخال والإلحاق", pages:"27–29", startStepId:"sql-insert-queries-mission" }),
            Object.freeze({ id:"delete-review", label:"استعلامات الحذف ومراجعة الدرس", pages:"30–34", startStepId:"sql-delete-review-mission" }),
          ]),
          xp:10,
        }),
      ]),
