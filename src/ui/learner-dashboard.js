...
function renderPremiumCard() {
  return `<section class="dashboard-premium" aria-labelledby="dashboard-premium-title">
    <div class="dashboard-premium__hero">
      <div class="dashboard-premium__top"><span class="dashboard-premium__badge" lang="en" dir="ltr">PREMIUM <span aria-hidden="true">✦</span></span><span class="dashboard-premium__edition">قيد الإعداد</span></div>
      <h2 id="dashboard-premium-title">نعمل على بريميوم</h2>
      <p class="dashboard-premium__intro">الاشتراك غير متاح حاليًا. واصل التعلّم في الدروس المتاحة.</p>
    </div>
...
export function renderDashboardSideRailMarkup(snapshot) {
  ...
  return `<div class="dashboard-side-rail__content">${renderPremiumCard()}<section class="dashboard-quests" aria-labelledby="dashboard-quests-title"><div class="dashboard-quests-teaser">${renderWorkingRocky("dashboard-quests-teaser__mascot")}<span>قيد الإعداد</span><h2 id="dashboard-quests-title">المهام اليومية</h2><p>نعمل على تجهيز هذه الميزة. الدروس المتاحة بانتظارك.</p></div></section></div>`;
}
...
export function renderLearnerDashboardMarkup(snapshot, displayName) {
  ...
  return `<section class="learner-dashboard" data-learner-dashboard aria-labelledby="learner-dashboard-title"><header class="learner-dashboard__header"><span class="learner-dashboard__avatar" aria-hidden="true"><svg viewBox="0 0 48 48" fill="none"><circle cx="24" cy="17" r="8" fill="currentColor"/><path d="M9 41c0-8.3 6.7-15 15-15s15 6.7 15 15" fill="currentColor"/></svg></span><div class="learner-dashboard__identity"><h2 id="learner-dashboard-title">مرحبًا، <bdi>${learnerName}</bdi></h2><p>${learning.hasStarted || learning.progress || learning.requiredLessonsCompleted ? "واصل تعلّمك من خريطة الدروس." : "اختر المادة المتاحة وابدأ خطوتك الأولى."}</p></div></header><div class="dashboard-stats" aria-label="ملخص التقدم"><article class="dashboard-stat dashboard-stat--level"><span class="dashboard-stat__icon">${icons.level}</span><div class="dashboard-stat__content"><div class="dashboard-stat__heading"><span>تقدّمك</span><strong class="level-value ui-number">${formatLevel(learning.level)}<img class="level-up-arrow" src="assets/icons/level-up-arrow.svg" alt="" aria-hidden="true" width="18" height="18" /></strong></div></div><div class="dashboard-stat__panel">${levelBar}</div></article><article class="dashboard-stat dashboard-stat--streak"><span class="dashboard-stat__icon">${icons.streak}</span><div class="dashboard-stat__content"><div class="dashboard-stat__heading"><span>السلسلة اليومية</span><strong class="ui-number">${formatStreak(streak)}</strong></div></div><div class="dashboard-stat__panel">${streakDays(streak)}</div></article></div><div class="dashboard-materials-heading"><div><h3>المواد الدراسية</h3><p>اختر مادة للبدء أو المتابعة.</p></div><span><bdi class="ui-number">${curriculumPercentage}%</bdi> مكتمل</span></div></section>`;
}
