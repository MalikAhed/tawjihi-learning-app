...
export function renderLessonLoading(container, day) {
  ...
  container.innerHTML = `
    <section class="lesson-hero lesson-hero--coming-soon lesson-loading" role="status" aria-live="polite" data-expanded-component>
...
export function renderLessonError(container, day, onRetry) {
  ...
  const arabic = /[\u0600-\u06ff]/.test(reference);
  container.innerHTML = `
    <section class="lesson-hero lesson-hero--coming-soon lesson-error" role="alert" data-expanded-component>
